...
But it's an example of how data journalists write paragraphs of stories out of analysis, combined with an example of how to create locally relevant versions of a story on a wide scale. 
